      ...
      <main className="flex-1 pt-24 pb-16 lg:pt-28 lg:pb-20">
        <div className="max-w-5xl lg:max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-5 lg:space-y-6">
            <div className="p-4.5 sm:p-5 lg:p-6 rounded-xl bg-slate-900 border border-slate-800">
              <h2 className="text-sm sm:text-base lg:text-lg font-bold text-white mb-3 uppercase">Identitas Badan Hukum Perseroan</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4 text-xs font-mono mb-4">
              ...
              <p className="text-slate-400 text-[11px] lg:text-xs leading-relaxed border-t border-slate-800 pt-3">
            ...
            <div className="p-4.5 sm:p-5 lg:p-6 rounded-xl bg-slate-900 border border-amber-500/30">

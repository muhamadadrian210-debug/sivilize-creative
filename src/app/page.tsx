  ...
  return (
    <div className="page-wrapper min-h-screen flex flex-col font-sans bg-[#07090e] text-slate-300 selection:bg-amber-500 selection:text-slate-950 overflow-x-hidden">
      ...
      <main className="flex-1">
        {/* 1. HERO SECTION */}
        <section className="relative pt-24 pb-10 sm:pt-28 sm:pb-12 md:pt-28 md:pb-14 lg:pt-32 lg:pb-16 border-b border-slate-800/80 overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold text-white tracking-tight leading-snug mb-3 max-w-2xl lg:max-w-3xl mx-auto">
              {hero.headingMain}{" "}
            ...
            <p className="text-slate-400 text-[11px] sm:text-xs lg:text-sm font-normal max-w-lg lg:max-w-xl mx-auto leading-relaxed mb-5">
              {hero.subtitle}
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 max-w-md mx-auto">
              <a
                ...
                className="w-full sm:w-auto px-5 py-2.5 lg:px-6 lg:py-3 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-extrabold text-xs lg:text-sm shadow-lg shadow-amber-500/20 transition-all hover:-translate-y-0.5 flex items-center justify-center gap-2 group"
              >
              ...
              <Link
                href="/tentang"
                className="w-full sm:w-auto px-5 py-2.5 lg:px-6 lg:py-3 rounded-xl bg-[#111622] hover:bg-[#182030] text-slate-200 font-bold text-xs lg:text-sm border border-slate-700/80 transition-all flex items-center justify-center gap-2"
              >
            ...
            {/* Dynamic Stats Grid */}
            <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-3 lg:gap-4 max-w-3xl lg:max-w-4xl mx-auto">
              {hero.stats.map((stat: any, idx: number) => (
                <div
                  key={idx}
                  className="p-2.5 sm:p-3 lg:p-4 rounded-lg bg-[#111622]/80 border border-slate-800/80 backdrop-blur-xl hover:border-amber-500/40 transition-colors group text-center"
                >
                  <div className="text-base sm:text-lg lg:text-xl font-bold text-amber-400 tracking-tight group-hover:scale-105 transition-transform">
                    {stat.value}
                  </div>
        ...
        <section className="py-10 md:py-12 lg:py-16 border-b border-slate-800/80 bg-[#07090e]">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-xl lg:max-w-2xl mx-auto mb-8 lg:mb-10">
              ...
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-white tracking-tight leading-tight leading-tight">
                Mengenal PT Sivilize Corp Indonesia &amp; Sivilize Creative
              </h2>
              <p className="text-slate-400 text-[11px] sm:text-xs lg:text-sm mt-1.5 leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-5 mb-8">
              {/* Card 1: Holding */}
              <div className="p-4.5 sm:p-5 lg:p-6 rounded-xl bg-[#111622] border border-slate-800/80 hover:border-amber-500/40 transition-all flex flex-col justify-between">
                <div>
                  <div className="w-9 h-9 lg:w-10 lg:h-10 rounded-lg bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-400 mb-3.5">
                    <Building2 className="w-4.5 h-4.5" />
                  </div>
                  <h3 className="text-sm lg:text-base font-bold text-white mb-1.5">PT SIVILIZE CORP INDONESIA</h3>
                  <p className="text-slate-400 text-[11px] lg:text-xs leading-relaxed mb-3">
              ...
              <div className="p-4.5 sm:p-5 lg:p-6 rounded-xl bg-[#111622] border border-slate-800/80 hover:border-amber-500/40 transition-all flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-sm lg:text-base font-bold text-white mb-1.5">Divisi Sivilize Creative</h3>
                  <p className="text-slate-400 text-[11px] lg:text-xs leading-relaxed mb-3">
              ...
              <div className="p-4.5 sm:p-5 lg:p-6 rounded-xl bg-[#111622] border border-slate-800/80 hover:border-amber-500/40 transition-all flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-sm lg:text-base font-bold text-white mb-1.5">Jaminan Legalitas &amp; SPK</h3>
                  <p className="text-slate-400 text-[11px] lg:text-xs leading-relaxed mb-3">
        ...
        <section className="py-10 md:py-12 lg:py-16 border-b border-slate-800/80 bg-[#0b0f17]">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-6 space-y-3.5">
                ...
                <p className="text-slate-300 text-[11px] sm:text-xs lg:text-sm leading-relaxed">
                ...
                <p className="text-slate-400 text-[11px] sm:text-xs lg:text-sm leading-relaxed">
              ...
              <div className="lg:col-span-6 space-y-4">
                <div className="p-4 sm:p-5 lg:p-6 rounded-xl bg-[#111622] border border-slate-800 hover:border-amber-500/30 transition-all shadow-lg">
                  <div className="flex items-center gap-2.5 mb-2.5">
                    <div className="w-7 h-7 lg:w-8 lg:h-8 rounded-md bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-400">
                      <Star className="w-3.5 h-3.5" />
                    </div>
                    <h3 className="text-xs sm:text-sm lg:text-base font-bold text-white uppercase tracking-wide">Visi Utama Perusahaan</h3>
                  </div>
                  <p className="text-slate-200 text-[11px] sm:text-xs lg:text-sm italic leading-relaxed bg-[#070b12] p-3 rounded-lg border border-slate-800">
                ...
                <div className="p-4 sm:p-5 lg:p-6 rounded-xl bg-[#111622] border border-slate-800 hover:border-amber-500/30 transition-all shadow-lg">
                  <div className="flex items-center gap-2.5 mb-2.5">
                    ...
                    <h3 className="text-xs sm:text-sm lg:text-base font-bold text-white uppercase tracking-wide">Misi Operasional Kami</h3>
                  </div>
                  <ul className="space-y-2">
                    <li className="text-[11px] sm:text-xs lg:text-sm text-slate-300 flex items-start gap-2">
        ...
        <section className="py-10 md:py-12 lg:py-16 border-b border-slate-800/80 bg-[#07090e]">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-5">
              ...
              <div className="p-4.5 sm:p-5 lg:p-6 rounded-xl bg-[#111622] border border-slate-800 hover:border-amber-500/40 transition-all flex flex-col justify-between shadow-lg">
                <div>
                  <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-lg bg-gradient-to-br from-amber-400 to-amber-600 p-0.5 mb-3.5 shadow-md shadow-amber-500/20">
                  ...
                  <h3 className="text-base lg:text-lg font-bold text-white mb-1.5">Muhamad Adrian</h3>
                  <p className="text-slate-300 text-[11px] lg:text-xs leading-relaxed mb-3">
              ...
              <div className="p-4.5 sm:p-5 lg:p-6 rounded-xl bg-[#111622] border border-slate-800 hover:border-amber-500/40 transition-all flex flex-col justify-between shadow-lg">
                <div>
                  <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-lg bg-gradient-to-br from-slate-700 to-slate-900 p-0.5 mb-3.5 border border-slate-700">
                  ...
                  <h3 className="text-base lg:text-lg font-bold text-white mb-1.5">Briand Jivencha Therik</h3>
                  <p className="text-slate-300 text-[11px] lg:text-xs leading-relaxed mb-3">
              ...
              <div className="p-4.5 sm:p-5 lg:p-6 rounded-xl bg-[#111622] border border-amber-500/40 hover:border-amber-400 transition-all flex flex-col justify-between shadow-lg">
                <div>
                  <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-lg bg-gradient-to-br from-amber-400 to-amber-600 p-0.5 mb-3.5 shadow-md shadow-amber-500/20">
                    <div className="w-full h-full bg-[#0b0f17] rounded-[6px] flex items-center justify-center text-amber-400 font-black text-xs">
                      SD
                  ...
                  <h3 className="text-base lg:text-lg font-bold text-white mb-1.5">Shatrya Dhimar</h3>
                  <p className="text-slate-300 text-[11px] lg:text-xs leading-relaxed mb-3">
        ...
        <section className="py-10 md:py-12 lg:py-16 border-b border-slate-800/80 bg-[#0b0f17]">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5">
              ...
              <Link
                href="/layanan"
                className="p-4 sm:p-4.5 lg:p-5 rounded-xl bg-[#111622] border border-slate-800/80 hover:border-amber-500/50 transition-all group flex flex-col justify-between hover:-translate-y-0.5"
              >
                <div>
                  <div className="w-8.5 h-8.5 lg:w-10 lg:h-10 rounded-lg bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-400 mb-3 group-hover:bg-amber-500 group-hover:text-slate-950 transition-all">
                    <Film className="w-4 h-4" />
                  </div>
                  <h3 className="text-sm lg:text-base font-bold text-white mb-1.5 group-hover:text-amber-400 transition-colors">
        ...
        <section className="py-10 md:py-12 lg:py-16 border-b border-slate-800/80 bg-[#07090e] relative">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="p-5 sm:p-7 rounded-2xl bg-gradient-to-br from-[#111622] via-[#0b0f17] to-[#151c2c] border border-amber-500/30 relative overflow-hidden shadow-xl">
              ...
              <div className="max-w-xl relative z-10">
                ...
                <p className="text-slate-300 text-[11px] sm:text-xs lg:text-sm leading-relaxed mb-4">

...
export function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 p-2 sm:p-3 flex justify-center transition-all duration-300">
      <div
        className={`w-full max-w-6xl h-14 rounded-full px-4 sm:px-5 flex items-center justify-between transition-all duration-300 backdrop-blur-xl border ${
          isScrolled
      ...
      >
        ...
        <Link href="/" className="flex items-center gap-2 group shrink-0 min-w-0">
          <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-gradient-to-br from-amber-400 to-amber-600 p-0.5 shadow-md shadow-amber-500/20 group-hover:scale-105 transition-transform shrink-0">
            <div className="w-full h-full bg-[#0b0f17] rounded-[7px] flex items-center justify-center">
              <Video className="w-4 h-4 text-amber-400" />
            </div>
          </div>
          <div className="flex flex-col min-w-0">
            <span className="text-xs font-black tracking-wider uppercase text-white group-hover:text-amber-400 transition-colors truncate max-w-[120px] min-[400px]:max-w-none">
              {logoText}
            </span>
        ...
        <div className="hidden md:flex items-center shrink-0">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-4 py-2 rounded-full bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 hover:from-amber-300 hover:to-amber-500 text-slate-950 font-black text-xs transition-all shadow-[0_0_15px_rgba(245,158,11,0.25)] hover:shadow-[0_0_20px_rgba(245,158,11,0.4)] flex items-center gap-1.5 group shrink-0 active:scale-95"
          >

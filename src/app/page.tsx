  ...
  return (
    <div className="page-wrapper min-h-screen flex flex-col font-sans bg-[#07090e] text-slate-300 selection:bg-amber-500 selection:text-slate-950 overflow-x-hidden">
      ...
      <main className="flex-1">
        {/* 1. HERO SECTION */}
        <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 border-b border-slate-800/80 overflow-hidden">
        ...
        <section className="py-16 border-b border-slate-800/80 bg-[#07090e]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              ...
              <div className="p-6 rounded-2xl bg-[#111622] border border-slate-800/80 hover:border-amber-500/40 transition-all flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-base font-bold text-white mb-2">PT SIVILIZE CORP INDONESIA</h3>
                  ...
                  <div className="space-y-1.5 text-[11px] font-mono text-slate-400 pt-3 border-t border-slate-800">
              ...
              <div className="p-6 rounded-2xl bg-[#111622] border border-slate-800/80 hover:border-amber-500/40 transition-all flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-base font-bold text-white mb-2">Divisi Sivilize Creative</h3>
                  <p className="text-slate-400 text-xs leading-relaxed mb-4">
              ...
              <div className="p-6 rounded-2xl bg-[#111622] border border-slate-800/80 hover:border-amber-500/40 transition-all flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-base font-bold text-white mb-2">Jaminan Legalitas &amp; SPK</h3>
                  <p className="text-slate-400 text-xs leading-relaxed mb-4">
        ...
        <section className="py-16 border-b border-slate-800/80 bg-[#0b0f17]">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              ...
              <div className="lg:col-span-6 space-y-5">
                <div className="p-6 rounded-2xl bg-[#111622] border border-slate-800 hover:border-amber-500/30 transition-all shadow-xl">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-8 h-8 rounded-lg bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-400">
                      <Star className="w-4 h-4" />
                    </div>
                    <h3 className="text-base font-bold text-white uppercase tracking-wide">Visi Utama Perusahaan</h3>
                  </div>
                  <p className="text-slate-200 text-xs sm:text-sm italic leading-relaxed bg-[#070b12] p-3.5 rounded-xl border border-slate-800">
                ...
                <div className="p-6 rounded-2xl bg-[#111622] border border-slate-800 hover:border-amber-500/30 transition-all shadow-xl">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-base font-bold text-white uppercase tracking-wide">Misi Operasional Kami</h3>
                  </div>
        ...
        <section className="py-16 border-b border-slate-800/80 bg-[#07090e]">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="p-6 rounded-2xl bg-[#111622] border border-slate-800 hover:border-amber-500/40 transition-all flex flex-col justify-between shadow-xl">
                <div>
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-400 to-amber-600 p-0.5 mb-5 shadow-lg shadow-amber-500/20">
                    <div className="w-full h-full bg-[#0b0f17] rounded-[10px] flex items-center justify-center text-amber-400 font-black text-base">
                      MA
                    </div>
                  </div>
                  <span className="text-amber-400 text-[10px] font-mono tracking-widest uppercase font-bold block mb-1">
                    FOUNDER &amp; CHIEF EXECUTIVE OFFICER (CEO)
                  </span>
                  <h3 className="text-lg font-bold text-white mb-2">Muhamad Adrian</h3>
              ...
              <div className="p-6 rounded-2xl bg-[#111622] border border-slate-800 hover:border-amber-500/40 transition-all flex flex-col justify-between shadow-xl">
                <div>
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-slate-700 to-slate-900 p-0.5 mb-5 border border-slate-700">
                    <div className="w-full h-full bg-[#0b0f17] rounded-[10px] flex items-center justify-center text-slate-300 font-black text-base">
                      BT
                    </div>
                  </div>
                  <span className="text-amber-400 text-[10px] font-mono tracking-widest uppercase font-bold block mb-1">
                  ...
                  <h3 className="text-lg font-bold text-white mb-2">Briand Jivencha Therik</h3>
                  <p className="text-slate-300 text-xs leading-relaxed mb-4">
              ...
              <div className="p-6 rounded-2xl bg-[#111622] border border-amber-500/40 hover:border-amber-400 transition-all flex flex-col justify-between shadow-xl">
                <div>
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-400 to-amber-600 p-0.5 mb-5 shadow-lg shadow-amber-500/25">
                    <div className="w-full h-full bg-[#0b0f17] rounded-[10px] flex items-center justify-center text-amber-400 font-black text-base">
                      SD
                    </div>
                  </div>
                  ...
                  <h3 className="text-lg font-bold text-white mb-2">Shatrya Dhimar</h3>
                  <p className="text-slate-300 text-xs leading-relaxed mb-4">
                ...
                <div className="pt-3 border-t border-amber-500/30 text-[11px] text-amber-400 font-mono font-bold flex items-center gap-1.5">
        ...
        <section className="py-16 border-b border-slate-800/80 bg-[#0b0f17]">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              ...
              <Link
                href="/layanan"
                className="p-5 sm:p-6 rounded-2xl bg-[#111622] border border-slate-800/80 hover:border-amber-500/50 transition-all group flex flex-col justify-between hover:-translate-y-0.5"
              >
                <div>
                  <div className="w-10 h-10 rounded-xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-400 mb-4 group-hover:bg-amber-500 group-hover:text-slate-950 transition-all">
        ...
        <section className="py-16 border-b border-slate-800/80 bg-[#07090e] relative">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="p-6 sm:p-10 rounded-3xl bg-gradient-to-br from-[#111622] via-[#0b0f17] to-[#151c2c] border border-amber-500/30 relative overflow-hidden shadow-2xl">
              <div className="absolute -right-20 -bottom-20 w-80 h-80 bg-amber-500/10 rounded-full blur-[100px] pointer-events-none" />

              <div className="max-w-2xl relative z-10">
                <span className="px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-400 text-xs font-mono font-bold uppercase tracking-wider inline-block mb-3">
                ...
                <div className="flex flex-wrap items-center gap-3.5">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-5 py-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-extrabold text-xs flex items-center gap-2 shadow-lg shadow-amber-500/20 transition"
                  >
                  ...
                  <Link
                    href="/harga"
                    className="px-5 py-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 font-bold text-xs border border-slate-700/80 transition"
                  >
